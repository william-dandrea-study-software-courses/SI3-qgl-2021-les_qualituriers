...
public class DeserializationTest {
    ...
    @Test
    void deserializeSailBoatEntity() {
    ...
    @Test
    void deserializeRudderBoatEntity() {
    ...
    @Test
    void deserializeWatchBoatEntity() {
    ...
    @Test
     void deserializeStreamVisibleDeckEntity() {
    ...
    @Test
     void deserializeReefVisibleDeckEntity() {
        Transform transform = new Transform(2.3, 4.1, Math.PI/2);
        Circle circle = new Circle(34);
    ...
    @Test
     void deserializeEnemyVisibleDeckEntity() {
        Transform transform = new Transform(2.3, 4.1, Math.PI/2);
        Circle circle = new Circle(34);
